...
function UserProfile(){
    ...
    return(
        ...
        {/* previous orders section */}
            <section className=" bg-blue-200 flex flex-col gap-4 justify-start items-center w-[95vw]  lg:w-[60vw] md:w-[70vw]  mt-10 rounded-2xl shadow-2xl text-2xl font-semibold text-center " >
                ...
                <div className=" flex flex-col gap-3 p-4 " >
                    ...
                    ): previouslyOrdredItems.map((p)=> <h2> {p.title} </h2> ) }
                </div>
            </section> 
        </div>
    )
